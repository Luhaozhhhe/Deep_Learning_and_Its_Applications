...
DATA_PATH = './data'
BATCH_SIZE = 64
SAVE_PATH = os.path.join('results', 'CIFAR100', args.model)
...
if args.model == 'cnn_base':
    ...
    model = ResNet_18(num_classes=100, ResidualBlock=BasicBlock)
elif args.model == 'cnn_resnet34':
    model = ResNet_34(num_classes=100, ResidualBlock=BasicBlock)
elif args.model == 'cnn_resnet50':
    model = ResNet_50(num_classes=100, ResidualBlock=Bottleneck)
elif args.model == 'cnn_resnet101':
    model = ResNet_101(num_classes=100, ResidualBlock=Bottleneck)
elif args.model == 'cnn_resnet152':
    model = ResNet_152(num_classes=100, ResidualBlock=Bottleneck)
elif args.model == 'cnn_densenet121':
    model = DenseNet_121(num_classes=100)
elif args.model == 'cnn_densenet169':
    model = DenseNet_169(num_classes=100)
elif args.model == 'cnn_densenet201':
    model = DenseNet_201(num_classes=100)
elif args.model == 'cnn_densenet264':
    model = DenseNet_264(num_classes=100)
elif args.model == 'cnn_se_resnet18':
    model = SE_ResNet18(num_classes=100)
elif args.model == 'cnn_se_resnet34':
    model = SE_ResNet34(num_classes=100)
elif args.model == 'cnn_se_resnet50':
    model = SE_ResNet50(num_classes=100)
elif args.model == 'cnn_se_resnet101':
    model = SE_ResNet101(num_classes=100)
